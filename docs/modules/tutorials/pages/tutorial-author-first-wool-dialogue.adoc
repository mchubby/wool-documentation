...
Once you have set up the new dialogue file, you can start writing your dialogue. The xref:../../language/pages/index.adoc[WOOL Language Documentation] provides an overview of the available language features, but we will discuss the very basics below.
